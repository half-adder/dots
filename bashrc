...
# Custom Aliases
alias longleaf='ssh seanjohn@longleaf.unc.edu'
alias aptx='java -Xmx2048m -cp ~/.local/bin/forester.jar org.forester.archaeopteryx.Archaeopteryx'
